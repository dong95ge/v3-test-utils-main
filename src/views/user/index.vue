    ...
    >
      <a-form ref="formRef" :model="currenItem" :rules="rules" @finish="onFinish">
        <a-form-item label="员工名称" name="name">
          <a-input v-model:value="currenItem.name" placeholder="请输入员工名称"/>
        </a-form-item>
        <a-form-item label="员工地址" name="address">
          <a-input v-model:value="currenItem.address" placeholder="请输入员工地址"/>
        </a-form-item>
        <a-form-item label="员工类型" name="type">
          ...
          <a-select-option value="1">外包</a-select-option>
        </a-select>
        </a-form-item>
        <a-form-item label="入职时间" name="date">
          <a-date-picker v-model:value="currenItem.date" placeholder="请选择入职时间" style="width: 100%"/>
        </a-form-item>
      </a-form>
    </a-modal>
  </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const columns = [
      { dataIndex: "name", title: "员工名称" },
      { dataIndex: "address", title: "员工地址" },
      { dataIndex: "type", title: "员工类型" },
      { dataIndex: "date", title: "职时间" },
